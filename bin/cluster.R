...
output_string <- sprintf("Elbow point in the percentage of variance explained by successive PCs: ", chosen.elbow, "\n")
...
for(Cell in Cell_types){
  ...
  ggsave(filename = paste0(Cell, "_vln_plot.png"), plot = plot, dpi = 300, width = 15, height = 8, units = "in")
}
